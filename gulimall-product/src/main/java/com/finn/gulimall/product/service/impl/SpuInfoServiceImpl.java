...
import com.finn.common.constant.ProductConstant;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    */
    ...
    public void up(Long spuId) {
        ...
        try {
            CommonResult<List<SkuHasStockVO>> skuHasStock = wareFeignService.getSkuHasStock(skuIdList);
            List<SkuHasStockVO> result = skuHasStock.getResult();
        ...
        R r = searchFeignService.productStatusUp(skus.stream().map(sku -> {
